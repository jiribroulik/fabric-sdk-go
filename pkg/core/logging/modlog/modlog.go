...
import (
	...
	"github.com/jiribroulik/fabric-sdk-go/pkg/core/logging/metadata"
)
...
func hasLoggerFnPrefix(pkgPath string, fnName string) bool {
	const (
		loggingAPIPath = "github.com/jiribroulik/fabric-sdk-go/pkg/core/logging/"
		loggingAPIPkg  = "api" // Go < 1.12
		modlogFnPrefix = "modlog.(*Log)."
		loggingPath    = "github.com/jiribroulik/fabric-sdk-go/pkg/common/"
		loggingPkg     = "logging"
		logBridgePath  = "github.com/jiribroulik/fabric-sdk-go/external/github.com/hyperledger/fabric-ca/sdkpatch/logbridge"
